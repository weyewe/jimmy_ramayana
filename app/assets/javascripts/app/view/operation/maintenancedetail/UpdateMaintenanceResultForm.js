Ext.define('AM.view.operation.maintenancedetail.Form', {
  ...
  alias : 'widget.updatemaintenanceresultform',
...
// if autoShow == true.. on instantiation, will automatically be called 
  ...
  initComponent: function() {
	...
	setParentData: function( record ){
		this.down('form').getForm().findField('maintenance_id').setValue(record.get('id')); 
		this.down('form').getForm().findField('machine_name').setValue(record.get('machine_name')); 
	},
