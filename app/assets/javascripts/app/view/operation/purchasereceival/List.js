Ext.define('AM.view.operation.purchasereceival.List' ,{
	...
	initComponent: function() {
		this.columns = [
			{ header: 'Receival Date', dataIndex: 'receival_date'},
			{	header: 'Pembelian', dataIndex: 'purchase_order_id', flex: 1 }, 
			{	header: 'Deskripsi', dataIndex: 'description', flex: 1 }, 
			{	header: 'Gudang', dataIndex: 'warehouse_name', flex: 1 }, 
