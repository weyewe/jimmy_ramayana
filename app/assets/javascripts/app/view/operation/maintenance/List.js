Ext.define('AM.view.operation.maintenance.List' ,{
	...
	initComponent: function() {
		this.columns = [
			{ header: 'Request Date', dataIndex: 'complaint_date'},
			{	header: 'Deskripsi', dataIndex: 'complaint', flex: 1 }, 
			{	header: 'Asset', dataIndex: 'asset_code', flex: 1 }, 
			{	header: 'Workshop', dataIndex: 'warehouse_name', flex: 1 }, 
